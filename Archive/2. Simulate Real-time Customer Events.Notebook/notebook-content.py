...
generate_order_udf = F.udf(generate_order, schema)
...
events = (
    ticks.withColumn("event", generate_order_udf(F.col("value")))
         .select("timestamp", "event.*")
         .withColumn("eventTime", F.col("timestamp"))
         .drop("timestamp")
)
